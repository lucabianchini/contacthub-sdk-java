...
public class ContactHub {
  ...
  public ContactHub(Auth auth, HttpClient httpClient) {
  ...
  public ContactHub(Auth auth, ClientData clientData, HttpClient httpClient) {
      this.auth = auth;
  ...
  public void addCustomerSession(String customerId, String sessionId)
    ...
    SessionApi.reconcile(this.auth, this.clientData, customerId, sessionId, this.httpClient);
  }
  ...
  public Customer getCustomer(String id)
      throws ApiException, ServerException, HttpException {
    return CustomerApi.getById(this.auth, this.clientData, id, this.httpClient);
  }
  ...
  public Paginated<Customer> getCustomers()
      throws ApiException, ServerException, HttpException {
    return CustomerApi.get(this.auth, this.clientData, GetCustomersOptions.builder().build(), this.httpClient);
  }
  ...
  public Paginated<Customer> getCustomers(GetCustomersOptions options)
      throws ApiException, ServerException, HttpException {
    return CustomerApi.get(this.auth, this.clientData, options, this.httpClient);
  }
  ...
  public Customer addCustomer(Customer customer)
      throws ApiException, ServerException, HttpException {
    return CustomerApi.add(this.auth, this.clientData, customer, this.httpClient);
  }
  ...
  public void deleteCustomer(String id)
      throws ApiException, ServerException, HttpException {
    CustomerApi.delete(this.auth, this.clientData, id, this.httpClient);
  }
  ...
  public Customer updateCustomer(Customer customer)
      throws ApiException, ServerException, HttpException {
    return CustomerApi.update(this.auth, this.clientData, customer, this.httpClient);
  }
  ...
  public Customer patchCustomer(String customerId, Customer patchCustomer)
      throws ApiException, ServerException, HttpException {
    return CustomerApi.patch(this.auth, this.clientData, customerId, patchCustomer, this.httpClient);
  }
  ...
  public Like addLike(String customerId, Like like)
      throws ApiException, ServerException, HttpException {
    return LikeApi.add(this.auth, this.clientData, customerId, like, this.httpClient);
  }
  ...
  public Like updateLike(String customerId, Like like)
      throws ApiException, ServerException, HttpException {
    return LikeApi.update(this.auth, this.clientData, customerId, like, this.httpClient);
  }
  ...
  public void removeLike(String customerId, String likeId)
      throws ApiException, ServerException, HttpException {
    LikeApi.remove(this.auth, this.clientData, customerId, likeId, this.httpClient);
  }
  ...
  public Job addJob(String customerId, Job job)
      throws ApiException, ServerException, HttpException {
    return JobApi.add(this.auth, this.clientData, customerId, job, this.httpClient);
  }
  ...
  public Job updateJob(String customerId, Job job)
      throws ApiException, ServerException, HttpException {
    return JobApi.update(this.auth, this.clientData, customerId, job, this.httpClient);
  }
  ...
  public void removeJob(String customerId, String jobId)
      throws ApiException, ServerException, HttpException {
    JobApi.remove(this.auth, this.clientData, customerId, jobId, this.httpClient);
  }
  ...
  public Education addEducation(String customerId, Education education)
      throws ApiException, ServerException, HttpException {
    return EducationApi.add(this.auth, this.clientData, customerId, education, this.httpClient);
  }
  ...
  public Education updateEducation(String customerId, Education education)
      throws ApiException, ServerException, HttpException {
    return EducationApi.update(this.auth, this.clientData, customerId, education, this.httpClient);
  }
  ...
  public void removeEducation(String customerId, String educationId)
      throws ApiException, ServerException, HttpException {
    EducationApi.remove(this.auth, this.clientData, customerId, educationId, this.httpClient);
  }
  ...
  public Customer addTag(String customerId, String tag)
      throws ApiException, ServerException, HttpException {
    return TagApi.add(this.auth, this.clientData, customerId, tag, this.httpClient);
  }
  ...
  public Customer removeTag(String customerId, String tag)
      throws ApiException, ServerException, HttpException {
    return TagApi.remove(this.auth, this.clientData, customerId, tag, this.httpClient);
  }
  ...
  public Event getEvent(String id)
      throws ApiException, ServerException, HttpException {
    return EventApi.getById(this.auth, this.clientData, id, this.httpClient);
  }
  ...
  public Paginated<Event> getEvents(String customerId)
      throws ApiException, ServerException, HttpException {
    return EventApi.get(this.auth, this.clientData, customerId, EventFilters.builder().build(), this.httpClient);
  }
  ...
  public Paginated<Event> getEvents(String customerId, EventFilters filters)
      throws ApiException, ServerException, HttpException {
    return EventApi.get(this.auth, this.clientData, customerId, filters, this.httpClient);
  }
